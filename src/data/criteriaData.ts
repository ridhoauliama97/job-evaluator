...
export const CRITERIA_DATA: Criteria[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: '1-2 tahun', value: 2 },
      { label: '3-5 tahun', value: 3 },
      { label: '6-10 tahun', value: 4 },
  ...
  },
  {
    ...
    options: [
      { label: '> 50 km', value: 1 },
      { label: '31-50 km', value: 2 },
      { label: '21-30 km', value: 3 },
      { label: '11-20 km', value: 4 },
      { label: '≤ 10 km', value: 5 },
    ],
  },
  {
    ...
    options: [
      ...
      { label: 'Rp. 3.000.000 – Rp. 4.999.999', value: 2 },
      { label: 'Rp. 5.000.000 – Rp. 6.999.999', value: 3 },
      { label: 'Rp. 7.000.000 – Rp. 9.999.999', value: 4 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '36-45 tahun', value: 2 },
      { label: '26-35 tahun', value: 3 },
      { label: '21-25 tahun', value: 4 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Cukup (2.5-3.0)', value: 2 },
      { label: 'Baik (3.1-3.9)', value: 3 },
      { label: 'Sangat Baik (4.0-4.5)', value: 4 },
